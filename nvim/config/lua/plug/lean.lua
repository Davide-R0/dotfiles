require('lean').setup {
    ...
    --[[
    opts = {
        -- Qui specifichiamo il motore da usare
        engine = {
            provider = {
                -- Indichiamo che vogliamo usare un generatore esterno
                -- compatibile con l'API di OpenAI
                kind = 'openai',
                api = {
                    -- Questo è l'indirizzo del tuo server Ollama locale
                    baseUrl = 'http://localhost:11434',
                    -- Per Ollama, la apiKey può essere una stringa qualsiasi
                    apiKey = 'ollama',
                },
            },
            model = {
                -- Inserisci qui il nome del modello che hai scaricato in Ollama
                -- Esempio: "llama3:8b" o "deepseek-coder:6.7b-instruct"
                name = 'DeepSeek-Prover-V2-7B-Q4',
            },
        },
    },]]--
